/* HE5.3 Write an algorithm
 * MAX-HEAP-CHANGE-KEY(A, n, i, key), to re-build a
 * n-element max-heap A, after the value at node with index
 * i has been changed to a new value key. Illustrate the
 * operation of MAX-HEAP-CHANGE-KEY(A, 12, 2, 2)
